...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, ProjectZstd.MOD_ID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        basicItem(ModItems.RAW_CITROFITE.get());
        basicItem(ModItems.PURE_CITROFITE.get());
        basicItem(ModItems.CITROFITE_CHARGE.get());
        ...
        handheldItem(ModItems.CITROFITE_SHOVEL);
        handheldItem(ModItems.CITROFITE_AXE);
        handheldItem(ModItems.CITROFITE_HOE);

        trimmedArmorItem(ModItems.CITROFITE_HELMET);
        trimmedArmorItem(ModItems.CITROFITE_CHESTPLATE);
    ...
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = ProjectZstd.MOD_ID; // Change this to your mod id
    ...
    private ItemModelBuilder handheldItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                ResourceLocation.fromNamespaceAndPath(ProjectZstd.MOD_ID,"item/" + item.getId().getPath()));
    }
}